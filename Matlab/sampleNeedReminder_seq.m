...
onode2 = dbn.names('Preferences');
onode3 = dbn.names('CheckedCalendarRecently');

for t=1:T,
  % sample value of variable
  oval1 = stoch_obs( 'Busyness', dbn, reminderVal );
  oval2 = stoch_obs( 'Preferences', dbn, reminderVal );
  oval3 = stoch_obs('CheckedCalendarRecently', dbn, reminderVal)
