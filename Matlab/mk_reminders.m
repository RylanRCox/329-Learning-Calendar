...
cpt = [ 0.5 0.7 0.9 0.1 0.3 0.5 0.2 0.3 0.4 0.01 0.05 0.1 ...
        0.5 0.3 0.1 0.9 0.7 0.5 0.8 0.7 0.6 0.99 0.95 0.9];
bnet.CPD{Urgency1} = tabular_CPD( bnet, 9, 'CPT', cpt );

% Pr(NeedReminder0)
cpt = [0.95 0.7 0.6 0.65 0.4 0.3 0.35 0.25 0.15 0.135 0.09 0.06 0.09 0.06 0.04 0.045 0.03 0.02 ...
       0.03 0.27 0.355 0.31 0.54 0.61 0.59 0.66 0.715 0.715 0.66 0.59 0.61 0.54 0.31 0.355 0.27 0.03 ...
       0.02 0.03 0.045 0.04 0.06 0.09 0.06 0.09 0.135 0.15 0.25 0.35 0.3 0.4 0.65 0.6 0.7 0.95];
bnet.CPD{NeedReminder0} = tabular_CPD( bnet, NeedReminder0, 'CPT', cpt );

% transition function, Pr(NeedReminder_t|NeedReminder_t-1)
cpt = [0.95 0.7 0.6 0.65 0.4 0.3 0.35 0.25 0.15 0.135 0.09 0.06 0.09 0.06 0.04 0.045 0.03 0.02 0.95 0.85 0.75 0.75 0.65 0.55 0.55 0.45 0.35 0.4075 0.205 0.07 0.08 0.02 0.01 0.09 0.06 0.04 0.95 0.9 0.85 0.9 0.85 0.8 0.85 0.8 0.75 0.24 0.19 0.14 0.19 0.14 0.09 0.14 0.09 0.04 ...
       0.03 0.27 0.355 0.31 0.54 0.61 0.59 0.66 0.715 0.715 0.66 0.59 0.61 0.54 0.31 0.355 0.27 0.03 0.01 0.09 0.16 0.17 0.23 0.27 0.18 0.145 0.0425 0.0425 0.145 0.18 0.27 0.23 0.14 0.16 0.09 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 0.01 ... 
       0.02 0.03 0.045 0.04 0.06 0.09 0.06 0.09 0.135 0.15 0.25 0.35 0.3 0.4 0.65 0.6 0.7 0.95 0.04 0.06 0.09 0.08 0.12 0.18 0.27 0.405 0.6075 0.55 0.65 0.75 0.65 0.75 0.85 0.75 0.85 0.95 0.04 0.09 0.14 0.09 0.14 0.19 0.14 0.19 0.24 0.75 0.8 0.85 0.8 0.85 0.9 0.85 0.9 0.95];
